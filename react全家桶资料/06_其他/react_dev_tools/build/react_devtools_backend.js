...
// That is done by the React Native Inspector pages.
 ...
 *
 * Resolve a style property into it's pages parts, e.g.
 *
...
function measureStyle(agent, bridge, resolveNativeStyle, id, rendererID) {
  ...
  const instance = data.instance,
        style = data.style;
  let resolvedStyle = resolveNativeStyle(style); // If it's a host pages we edited before, amend styles.
...
function renameStyle(agent, id, rendererID, oldName, newName, value) {
  ...
  if (instance !== null && typeof instance.setNativeProps === 'function') {
    // In the case of a host pages, we need to use setNativeProps().
